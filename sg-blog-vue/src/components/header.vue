...
<div class="">
			...
			<el-col :span="24">
				...
				<div class="headBox">
					<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
						...
						<el-menu-item index="/SendArticle"><i class="fa fa-file-text-o"></i>发表文章</el-menu-item>
						<el-menu-item index="/LeaveMessage"><i class="fa fa-file-text-o"></i>留言</el-menu-item>
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/headbg05c.jpg)'}">
		<div class="scene">
		...
		<div class="h-information">
			...
			<h2 class="h-description">
                        ...
                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"青春充满了不眠，是为了追寻更多的明天"}}
...
.headBox li.is-active {
	/*background: #48456C;*/
	background: rgba(48, 48, 48, 0.884);
}
