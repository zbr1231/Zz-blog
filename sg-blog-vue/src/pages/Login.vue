        ...
        <div class="container">
            ...
            <div v-show="!err2005" class="">
                <div v-if="login==1" class="loginBox">
                    ...
                    <h3><a @click="alertForget()" href="javascript:;">忘记密码？</a></h3>
                    <el-alert
                        v-show="forget"
                        :title="'请联系管理员'"
                        type="error"
                ...
                <div v-else class="registerBox">
                    ...
                    <div>
                        <el-input style="width: 70%;margin-right: 10px;"
                            type="text"
                            placeholder="邀请码 (联系管理员获取)"
                            v-model="code">
                        </el-input>
                        <span @click="getCode()" style="user-select: none;text-align: center;">
                            <div style="display: inline-block;width: 25%;" id="v-code">获取邀请码</div>
                        </span>
                    </div>
                    <el-alert
                        v-show="codeErr"
    ...
    export default {
        ...
        methods: { //事件处理器
            ...
            getCode: function(userId){
                let second = document.getElementById('v-code')
                second.innerHTML = '60'
                let t = setInterval(function(){
                    if(second.innerHTML==1){
                        second.innerHTML = '获取邀请码'
                        clearInterval(t)
                        return;
                    }
            ...
            newRegister:function(){//注册提交
                ...
                if(!that.nusernameErr&&!that.nemailErr&&!that.npasswordErr&&!that.codeErr){
